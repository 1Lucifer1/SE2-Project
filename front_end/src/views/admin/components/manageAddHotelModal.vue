<template>
    <a-modal
            :visible="manageAddHotelModalVisible"
            title="添加酒店"
            cancelText="取消"
            okText="确定"
            @cancel="cancel"
            ...
            <a-form-item label="酒店商圈" v-bind="formItemLayout">
                <a-select
                    ...
                    { rules: [{ required: true, message: '请选择酒店商圈' }] }]"
                        @change="changeStar"
                >
                    <a-select-option value="XiDan">XiDan</a-select-option>
                </a-select>
            </a-form-item>
    ...
    export default {
        ...
        computed: {
            ...mapGetters([
                'userId',
                'addHotelParams',
                'manageAddHotelModalVisible',
                'currentManagerId'
            ])
        },
        beforeCreate() {
            this.form = this.$form.createForm(this, { name: 'manageAddHotelModal' });
        },
        mounted() {
        ...
        methods: {
            ...
            cancel() {
                this.set_manageAddHotelModalVisible(false)
            },
            changeStar(v){
                ...
                this.form.validateFieldsAndScroll((err, values) => {
                    if (!err) {
                        const data = {
                            ...
                            managerId: Number(this.currentManagerId),
