...
<!--                    v-decorator="[-->
<!--              'registerUserType',-->
<!--              {rules: [{ required: true, message: '请输入想注册的类型' }], validateTrigger: 'blur'}]">-->
<!--              <a-select-option value="HotelManager">酒店管理</a-select-option>-->
<!--              <a-select-option value="Manager">网站管理</a-select-option>-->
<!--              <a-select-option value="Client">个人账号</a-select-option>-->
<!--              &lt;!&ndash;              <a-icon slot="prefix" type="book" :style="{ color: 'rgba(0,0,0,.25)' }"/>&ndash;&gt;-->
<!--            </a-select>-->
<!--          </a-form-item>-->
          <a-form-item>
            <a-date-picker
...
<!--                    v-decorator="[-->
<!--              'registerBirthday',-->
<!--              {rules: [{ required: true, type: 'date', message: '请输入生日' }], validateTrigger: 'blur'}]">-->
  ...
  export default {
    ...
    methods: {
      ...
      handleRegister() {
        ...
        const validateFieldsKey = this.customActiveKey === 'tab1' ? ['username', 'password'] : ['registerUserType','registerBirthday','registerUsername','registerPhoneNumber','registerUserMail','registerPassword','registerPasswordconfirm']
        validateFields(validateFieldsKey, { force: true }, async (err, values) => {
          if (!err) {
            ...
            const data = {
              ...
              credit: 100,
              userType: 0,
              birthday: moment(this.form.getFieldValue('registerBirthday')).format('YYYY-MM-DD'),
